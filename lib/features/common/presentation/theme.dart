...
const portalGreen = Color(
  0xFF97F049,
); // Bright green for portals and primary actions
const rickBlue = Color(0xFFA2D1F5); // Light blue from Rick's hair, for accents
const mortyYellow = Color(
  0xFFF3E64F,
); // Yellow from Morty's shirt, for highlights
const spaceDark = Color(
  0xFF201931,
); // Deep space color for backgrounds or dark themes
...
const accentPink = Color(
  0xFFE4448B,
); // A vibrant accent for special UI elements
const darkGreen = Color(
  0xFF448A39,
); // A more subdued green for text or secondary elements
...
const inverseAlternativeColor = Color(
  0xFF3a3252,
); // A lighter shade of spaceDark
